...
- (void)viewDidLoad
{
    ...
    NSAttributedString *sub2 = [[NSMutableAttributedString alloc] initWithString:@"Gaff-rigged Topsail schooner\n" attributes:subattrs];
    ...
    NSAttributedString *sub3 = [[NSAttributedString alloc] initWithString:@"Bridgeport, CT\n" attributes:subattrs];
    ...
    NSAttributedString *sub4 = [[NSMutableAttributedString alloc] initWithString:@"74 ft\n" attributes:subattrs];
    ...
    NSAttributedString *sub5 = [[NSAttributedString alloc] initWithString:@"10 ft.\n" attributes:subattrs];
    ...
    NSAttributedString *sub6 = [[NSMutableAttributedString alloc] initWithString:@"19 ft.\n" attributes:subattrs];
    ...
    NSAttributedString *sub7 = [[NSAttributedString alloc] initWithString:@"96 ft.\n" attributes:subattrs];
    ...
    NSAttributedString *sub8 = [[NSMutableAttributedString alloc] initWithString:@"9,688 sq. ft.\n" attributes:subattrs];
    ...
    NSAttributedString *sub9 = [[NSAttributedString alloc] initWithString:@"74 GRT\n" attributes:subattrs];
    ...
    NSAttributedString *sub10 = [[NSAttributedString alloc] initWithString:@"9\n" attributes:subattrs];
    ...
    imageArray = [[NSArray alloc] initWithObjects:@"Unicorn_1.png", @"Unicorn_2.png", @"Unicorn_3.png", nil];
...
- (void)didReceiveMemoryWarning
{
 ...
 [self.scrollViewVertical setContentSize:CGSizeMake(0, 1224)];
 }
