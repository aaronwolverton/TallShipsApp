...
#import "MadelineViewController.h"

@interface MadelineViewController ()
...
@implementation MadelineViewController
...
- (void)viewDidLoad
{
    ...
    imageArray = [[NSArray alloc] initWithObjects:@"Madeline_1.png", @"Madeline_2.png", @"Madeline_3.png", nil];
...
- (void)didReceiveMemoryWarning
{
 ...
 [self.scrollViewVertical setContentSize:CGSizeMake(0, 893)];
 }
