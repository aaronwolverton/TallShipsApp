...
#import "SorlandetViewController.h"

@interface SorlandetViewController ()

#define kfontsize 16

@end

@implementation SorlandetViewController
...
- (void)viewDidLoad
{
    ...
    NSAttributedString *sub1 = [[NSAttributedString alloc] initWithString:@"Norway\n" attributes:subattrs];
    ...
    NSAttributedString *sub2 = [[NSMutableAttributedString alloc] initWithString:@"Full Square Rigged\n" attributes:subattrs];
    ...
    NSAttributedString *sub3 = [[NSAttributedString alloc] initWithString:@"Kristiansand, Norway\n" attributes:subattrs];
    ...
    NSAttributedString *sub4 = [[NSMutableAttributedString alloc] initWithString:@"186 ft\n" attributes:subattrs];
    ...
    NSAttributedString *sub5 = [[NSAttributedString alloc] initWithString:@"7 ft. 7 in.\n" attributes:subattrs];
    ...
    NSAttributedString *sub6 = [[NSMutableAttributedString alloc] initWithString:@"29 ft.\n" attributes:subattrs];
    ...
    NSAttributedString *sub7 = [[NSAttributedString alloc] initWithString:@"111 ft.\n" attributes:subattrs];
    ...
    NSAttributedString *sub8 = [[NSMutableAttributedString alloc] initWithString:@"13,300 sq. ft.\n" attributes:subattrs];
    ...
    NSAttributedString *sub9 = [[NSAttributedString alloc] initWithString:@"499 GRT\n" attributes:subattrs];
    ...
    NSAttributedString *sub10 = [[NSAttributedString alloc] initWithString:@"20\n" attributes:subattrs];
    ...
    imageArray = [[NSArray alloc] initWithObjects:@"Sorlandet_1.png", @"Sorlandet_2.png", @"Sorlandet_3.png", nil];
...
- (void)didReceiveMemoryWarning
{
 ...
 [self.scrollViewVertical setContentSize:CGSizeMake(0, 977)];
 }
