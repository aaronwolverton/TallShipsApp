...
#import "PeacemakerViewController.h"

@interface PeacemakerViewController ()

#define kfontsize 16

@end

@implementation PeacemakerViewController
...
- (void)viewDidLoad
{
    ...
    NSAttributedString *sub2 = [[NSMutableAttributedString alloc] initWithString:@"Barquentine\n" attributes:subattrs];
    ...
    NSAttributedString *sub3 = [[NSAttributedString alloc] initWithString:@"Wilmington, DE\n" attributes:subattrs];
    ...
    NSAttributedString *sub4 = [[NSMutableAttributedString alloc] initWithString:@"128 ft\n" attributes:subattrs];
    ...
    NSAttributedString *sub5 = [[NSAttributedString alloc] initWithString:@"14 ft.\n" attributes:subattrs];
    ...
    NSAttributedString *sub6 = [[NSMutableAttributedString alloc] initWithString:@"33 ft.\n" attributes:subattrs];
    ...
    NSAttributedString *sub7 = [[NSAttributedString alloc] initWithString:@"126 ft.\n" attributes:subattrs];
    ...
    NSAttributedString *sub8 = [[NSMutableAttributedString alloc] initWithString:@"10,000 sq. ft.\n" attributes:subattrs];
    ...
    NSAttributedString *sub9 = [[NSAttributedString alloc] initWithString:@"297 GRT\n" attributes:subattrs];
    ...
    NSAttributedString *sub10 = [[NSAttributedString alloc] initWithString:@"11\n" attributes:subattrs];
    ...
    imageArray = [[NSArray alloc] initWithObjects:@"Peacemaker_1.png", @"Peacemaker_2.png", @"Peacemaker_3.png", nil];
...
- (void)didReceiveMemoryWarning
{
 ...
 [self.scrollViewVertical setContentSize:CGSizeMake(0, 933)];
 }
