...
- (void)viewDidLoad
{
    ...
    NSAttributedString *sub9 = [[NSAttributedString alloc] initWithString:@"35 GRT\n" attributes:subattrs];
    ...
    imageArray = [[NSArray alloc] initWithObjects:@"Pathfinder_1.png", @"Pathfinder_2.png", @"Pathfinder_3.png", nil];
...
- (void)didReceiveMemoryWarning
{
 ...
 [self.scrollViewVertical setContentSize:CGSizeMake(0, 947)];
 }
