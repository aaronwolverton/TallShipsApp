//
//  PrideofBaltimoreViewController.m
//  TallShipCelebration
//
...
#import "PrideofBaltimoreViewController.h"

@interface PrideofBaltimoreViewController ()

#define kfontsize 16

@end

@implementation PrideofBaltimoreViewController
...
- (void)viewDidLoad
{
    ...
    NSAttributedString *sub2 = [[NSMutableAttributedString alloc] initWithString:@"Square Topsail Schooner\n" attributes:subattrs];
    ...
    NSAttributedString *sub3 = [[NSAttributedString alloc] initWithString:@"Baltimore, MD\n" attributes:subattrs];
    ...
    NSAttributedString *sub4 = [[NSMutableAttributedString alloc] initWithString:@"108 ft\n" attributes:subattrs];
    ...
    NSAttributedString *sub5 = [[NSAttributedString alloc] initWithString:@"12 ft. 5 in.\n" attributes:subattrs];
    ...
    NSAttributedString *sub6 = [[NSMutableAttributedString alloc] initWithString:@"26 ft.\n" attributes:subattrs];
    ...
    NSAttributedString *sub7 = [[NSAttributedString alloc] initWithString:@"107 ft.\n" attributes:subattrs];
    ...
    NSAttributedString *sub8 = [[NSMutableAttributedString alloc] initWithString:@"9,000 sq. ft.\n" attributes:subattrs];
    ...
    NSAttributedString *sub9 = [[NSAttributedString alloc] initWithString:@"97 GRT\n" attributes:subattrs];
    ...
    NSAttributedString *sub10 = [[NSAttributedString alloc] initWithString:@"17\n" attributes:subattrs];
    ...
    imageArray = [[NSArray alloc] initWithObjects:@"PrideOfBaltimore_1.png", @"PrideOfBaltimore_2.png", @"PrideOfBaltimore_3.png", nil];
    ...
    NSLog(@"Pride of Baltimore View Loaded");
}
...
- (void)didReceiveMemoryWarning
{
 ...
 [self.scrollViewVertical setContentSize:CGSizeMake(0, 1050)];
 }
