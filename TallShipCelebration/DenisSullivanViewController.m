...
#import "DenisSullivanViewController.h"

@interface DenisSullivanViewController ()
...
@implementation DenisSullivanViewController
...
- (void)viewDidLoad
{
    ...
    NSAttributedString *sub2 = [[NSMutableAttributedString alloc] initWithString:@"3 Masted Schooner\n" attributes:subattrs];
    ...
    NSAttributedString *sub3 = [[NSAttributedString alloc] initWithString:@"Milwaukee, WI\n" attributes:subattrs];
    ...
    NSAttributedString *sub4 = [[NSMutableAttributedString alloc] initWithString:@"99 ft\n" attributes:subattrs];
    ...
    NSAttributedString *sub6 = [[NSMutableAttributedString alloc] initWithString:@"24 ft.\n" attributes:subattrs];
    ...
    NSAttributedString *sub8 = [[NSMutableAttributedString alloc] initWithString:@"4,597 sq. ft.\n" attributes:subattrs];
    ...
    NSAttributedString *sub9 = [[NSAttributedString alloc] initWithString:@"99 GRT\n" attributes:subattrs];
    ...
    imageArray = [[NSArray alloc] initWithObjects:@"D_Sullivan1.png", @"D_Sullivan3.png", @"D_Sullivan2.png", nil];
    ...
    NSLog(@"Denis Sullivan View Loaded");
}
...
- (void)viewDidLayoutSubviews
{
    ...
    [self.scrollViewVertical setContentSize:CGSizeMake(0, 898)];
}
